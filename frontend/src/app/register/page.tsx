                ...
                <form style={{
                    ...
                    <div style={{
                        ...
                        <input
                            ...
                            required
                        />
                        <div className="icons" onClick={togglePassword} style={{display:'flex', flexDirection:'row'}}>
                            {showPassword ? (
                                <svg
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-eye-fill" viewBox="0 0 16 16" style={{
                                    position: 'absolute',
                                    right: '8px',
                                    top: '50%',
                                    transform: 'translateY(-50%)',
